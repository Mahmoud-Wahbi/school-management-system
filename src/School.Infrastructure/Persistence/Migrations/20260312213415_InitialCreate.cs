    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassRoomSubjectTeachers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassRoomSubjectTeachers_AcademicYears_AcademicYearId",
                        column: x => x.AcademicYearId,
                        principalTable: "AcademicYears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClassRoomSubjectTeachers_ClassRooms_ClassRoomId",
                        column: x => x.ClassRoomId,
                        principalTable: "ClassRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClassRoomSubjectTeachers_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClassRoomSubjectTeachers_Teachers_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassRooms_AcademicYearId_GradeLevel_Section",
                table: "ClassRooms",
                columns: new[] { "AcademicYearId", "GradeLevel", "Section" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassRoomSubjectTeachers_AcademicYearId",
                table: "ClassRoomSubjectTeachers",
                column: "AcademicYearId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassRoomSubjectTeachers_ClassRoomId_SubjectId_AcademicYearId",
                table: "ClassRoomSubjectTeachers",
                columns: new[] { "ClassRoomId", "SubjectId", "AcademicYearId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClassRoomSubjectTeachers_SubjectId",
                table: "ClassRoomSubjectTeachers",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassRoomSubjectTeachers_TeacherId",
                table: "ClassRoomSubjectTeachers",
                column: "TeacherId");
